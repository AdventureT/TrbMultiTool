...
namespace TrbMultiTool.FileFormats
{
	public class Symb : Tag
	{
		...
		public Symb() : base()
		{
			...
			{
				NameEntries.Add(new NameEntry() { ID = Trb._f.ReadInt16(), Name = Trb._f.ReadStringFromOffset(Trb._f.ReadUInt32() + nameEntryOffset), NameID = Trb._f.ReadUInt16(), DataOffset = Trb._f.ReadUInt32() });
			}
